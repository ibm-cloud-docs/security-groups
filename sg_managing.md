...
3. On the Security Groups page, click a security group name to open the Details page.
...
4. In the Security Group section, you can assign predefined security groups to a network interface of a virtual server instance.
   ...
   {: important}
     ...
     When you assign a new security group, it prevents new connections from being established according to the security group rule definitions. However, existing socket connections are not closed.
